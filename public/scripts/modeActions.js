 ...
 *************************************************************************/
 for (let i = 0; i < GlobalModeActionButtons.length; ++i) {
    GlobalModeActionButtons[i].addEventListener("click", () => {
        const stateObj = {page: "MODE_DIALOG", mode: i, path: GlobalDialogPaths[i]};           
        transitionToDialog(GlobalModeActionDialogs[i],GlobalDialogTitles[i],
                           stateObj, GlobalDialogCancelButtons[i], GlobalDialogPrepFuncs[i]);
    });
  };
...
//ROUNDS mode
GlobalDialogCancelButtons[1].addEventListener("click",() => {
 ...
 * each mode's dialog box
 *************************************************************************/
 function keyDownModeDialogFocused(e) {
