...
GlobalModeNames=["ACTIVITY_FEED", "ROUNDS","COURSES","BUDDIES"];
...
const GlobalModeDialogActionNames = ["newpost","newround","addcourse","findbuddies"];

/*****************************************************/
/* GLOBAL TOAST                                      */
/*****************************************************/
const GlobalToast = document.getElementById("globalToast");
const GlobalToastClose = document.getElementById("globalToastClose");
const GlobalToastMsg = document.getElementById("globalToastMsg");

GlobalToastClose.addEventListener("click",function() {
  GlobalToast.classList.add("hidden");
});

function showToast(msg, withTabs=true) {
  GlobalToastMsg.textContent = msg;
  GlobalToast.classList.remove("hidden");
  if (withTabs) {
    GlobalModeTabsContainer.classList.remove("toast-container-noTabs");
    GlobalModeTabsContainer.classList.add("toast-container-tabs");
  } else {
    GlobalModeTabsContainer.classList.remove("toast-container-tabs");
    GlobalModeTabsContainer.classList.add("toast-container-noTabs");
  }
}
...
const GlobalLoginPageToast = document.getElementById("loginPageToast");
const GlobalLoginPageToastClose = document.getElementById("loginPageToastClose");
const GlobalLoginPageToastMsg = document.getElementById("loginPageToastMsg");
const GlobalGithubSignInBtn = document.getElementById("githubSignInBtn");
...
const GlobalProfileOAuthProviderField = document.getElementById("profileOAuthProvider");
const GlobalProfileRoleField = document.getElementById("profileRole");
...
const GlobalAllClubs = ["1W","3W","4W","5W","Hybrid","1I","2I","3I","4I","5I","6I","7I","8I","9I","PW","GW","SW","LW","Putter"];
...
const GlobalDialogPaths = ["activityfeed/newpost","rounds/newround","courses/add","buddies/find"];
 ...
 *************************************************************************/
 function transitionToDialog(dialog, dialogTitle, stateObj, closeBtn, dialogPrepFunc) {
  ...
  if (GlobalHistoryLogging) {
    console.log("Console: In transitionToDialog: Pushing state: " + JSON.stringify(stateObj) + " and setting URL to: " + stateObj.path);
 ...
 *************************************************************************/
 function transitionFromDialog(dialogToClose) {
  ...
  if (GlobalHistoryLogging) {
    console.log("Console: In transitionFromDialog: Popping state");
    history.back();
  }
}
