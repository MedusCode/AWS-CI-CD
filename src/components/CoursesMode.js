...
export default function CoursesMode() {
    ...
    function openCourseDetailsDialog(c) {
        const historyObj = {page: "COURSE_DETAILS", path: "/courses/" + c.id};
        window.transitionToDialog(null,"View/Edit Course Details for " + c.shortName,
                                  historyObj, "coursesModeDetailsCancelBtn", function(){});
     ...
     *************************************************************************/
    function closeCourseDetailsDialog(updatedCourse, courseId = null) {
     ...
     *************************************************************************/
    function openAddCourseDialog() {
        const historyObj = {page: "ADD_COURSE", mode: 2, path: "/courses/add"};
        const closeBtn = "coursesModeCancelBtn";
        window.transitionToDialog(null,"Add Course",historyObj,closeBtn,function(){});
    ...
    return(
      ...
      (showCourseDetailsDialog !== null) ?
         ...
         <>
            ...
            <button id="coursesModeAddBtn" className="float-btn" onClick={openAddCourseDialog}>
